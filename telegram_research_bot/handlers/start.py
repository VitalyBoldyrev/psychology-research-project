...
async def _start_registration(
    ...
    await message.answer(
        '👋 Здравствуйте!\n\n'
        'Нам очень важно знать Ваше мнение по поводу изучения эффективности '
        'решения логических задач, поэтому мы просим Вас принять участие '
        'в нашем исследовании, ответив на вопросы.\n\n'
        'Это займет ~30 минут, но даст Вам конкурентное преимущество '
        'в любой области и жизненной ситуации, поскольку:\n'
        '- Вы получите оценку Вашей внимательности к деталям;\n'
        '- А также разовьете навык критического самоконтроля: научитесь '
        'проверять выводы и исправлять ошибки до их фиксации.\n\n'
        'Параллельно Вы ПОМОЖЕТЕ создать эффективные образовательные '
        'инструменты, способствующие развитию науки.\n\n'
        'Пожалуйста, отвечайте на вопросы без стеснения, честно и открыто. '
        'Участие в исследовании строго КОНФИДЕНЦИАЛЬНО. Персональные ответы '
        'нигде опубликованы не будут.\n\n'
        'Вам предстоит:\n'
        '1️⃣ Заполнить краткую анкету;\n'
        '2️⃣ Решить задачи;\n'
        '3️⃣ Пройти тестирование на сайте: https://4k.hse.ru/ '
        '(индивидуальный логин для входа будет выдан через данный бот).\n\n'
        'ВАЖНЫЕ ТЕХНИЧЕСКИЕ МОМЕНТЫ:\n\n'
        '1) Если у вас что-то сломалось или есть вопросы, '
        'то вы можете написать мне: @aisstti\n\n'
        '2) Если бот завис, то его можно перезапустить через команду /start '
        'и вы продолжите с того же вопроса, на котором остановились\n\n'
        '3) Рекомендуем при прохождении исследования подключиться к Wi-Fi сети '
        'и VPN для избежания возможных сбоев и ошибок\n\n'
        '4) При завершении тестирования Вам будет предоставлена '
